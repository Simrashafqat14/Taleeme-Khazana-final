...
class uploadBags extends StatefulWidget {
  final String id, type;
  final bool isGrouped;
  const uploadBags({Key? key, required this.id, required this.type, required this.isGrouped}) : super(key: key);

  @override
  State<uploadBags> createState() => _uploadBagsState(id, type, isGrouped);
}

class _uploadBagsState extends State<uploadBags> {
  String id, type;
  bool isGrouped;
  _uploadBagsState(this.id, this.type, this.isGrouped);
  final _formKey = GlobalKey<FormBuilderState>(); // View, modify, validate form data
  var categoryOptions = ['Book','Uniform','Shoes'];
    ...
    if(type == "Exchange"){
      ...
      exchangeFields = Column(
        children: [
          ...
          //]
          // else ...[
          //   container = FormBuilderTextField(
          //     autovalidateMode:AutovalidateMode.onUserInteraction,
          //     controller: requiredamountorproductController,
          //     name: 'exchangeProduct',
          //     maxLines: 3,
          //     decoration: InputDecoration(
          //         labelText: 'Which product do you require?'
          //     ),
          //     validator: FormBuilderValidators.compose(
          //         [FormBuilderValidators.required()]),
          //   ),
                    ...
                    Container(
                      child: TextButton(onPressed: (){
                        ...
                        if(_formKey.currentState?.validate() == true) {
                          ...
                          print("Category:" + ColorController.toString());
                          print("Category:" + typeController.toString());
                          print("Category:" + GradeController.toString());
                          print("Type:" + OtherdetailsController.toString());


                          _insertProduct(type, context, id, productnameController.text, producrdescriptionController.text, _base64Image, productconditionController, ColorController.text, GradeController.text, typeController.text, OtherdetailsController.text, reasonforexchangeController.text, exchangeSourceController.toString(), requiredamountorproductController.text, formattedDate.toString(), isGrouped, quantityofGroupedProductsController.text);
                          Navigator.push(
...
Future<void> _insertProduct(String _type, BuildContext context, String userid,String _productname,String _productDescription, String _image, double _condition, String _color, String _grade, String _Bagtype, String _otherDetails, String _exchangereason, String _exchangesource, String _requiredamountorproduct, String _dateTime, bool _isGrouped, String _quantityofGroupedProducts ) async {
