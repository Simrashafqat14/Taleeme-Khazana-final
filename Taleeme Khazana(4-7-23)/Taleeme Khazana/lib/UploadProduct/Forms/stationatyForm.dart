...
class uploadStationary extends StatefulWidget {
  final String id, type;
  final bool isGrouped;
  const uploadStationary({Key? key, required this.id, required this.type, required this.isGrouped}) : super(key: key);

  @override
  State<uploadStationary> createState() => _uploadStationaryState(id, type, isGrouped);
}

class _uploadStationaryState extends State<uploadStationary> {
  String id, type;
  bool isGrouped;
  _uploadStationaryState(this.id, this.type, this.isGrouped);
  ...
  Widget build(BuildContext context) {
    ...
    if(type == "Donate"){
      Heading = Text('Donate Stationary',
    ...
    if(type == "Exchange"){
      Heading = Text('Exchange Stationary',
        style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,
          fontSize: 20,), textAlign: TextAlign.center,);
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    FormBuilderTextField(
                      ...
                      name: 'stationaryname',
                      decoration: InputDecoration(
                          labelText: 'Enter Stationary Name'
                      ),
                    ...
                    FormBuilderTextField(
                      ...
                      name: 'color',
                      decoration: InputDecoration(
                          labelText: 'Enter Color of stationary'
                      ),
                    ...
                    Container(
                      child: TextButton(onPressed: (){
                        ...
                        if(_formKey.currentState?.validate() == true) {
                          ...
                          print("Category:" + stationarynameController.toString());
                          print("Type:" + ColorController.toString());
                          print("Type:" + OtherdetailsController.toString());
                          print("Type:" + noofitemsController.toString());


                          _insertProduct(type,context, id, productnameController.text, producrdescriptionController.text, _base64Image, productconditionController, stationarynameController.text, noofitemsController.text, ColorController.text, OtherdetailsController.text, reasonforexchangeController.text, exchangeSourceController.toString(), requiredamountorproductController.text, formattedDate.toString(), isGrouped, quantityofGroupedProductsController.text);
                          Navigator.push(
...
Future<void> _insertProduct(String _type, BuildContext context, String userid,String _productname,String _productDescription, String _image, double _condition, String _stationaryname, String _noofitems, String _color, String _otherDetails, String _exchangereason, String _exchangesource, String _requiredamountorproduct, String _dateTime, bool _isGrouped, String _quantityofGroupedProducts ) async {
  ...
  if(_type == "Donate") {
    final data = MongoDbProducts(id: _id,
        ...
        shoesstyle: "",
        bagtype: "",
        stationaryname: _stationaryname,
        noofitemsstationary: _noofitems,
        grade: "",
        gender: "",
        color: _color,
