...
class uploadUniforms extends StatefulWidget {
  final String id, type;
  final bool isGrouped;
  const uploadUniforms({Key? key, required this.id, required this.type, required this.isGrouped}) : super(key: key);

  @override
  State<uploadUniforms> createState() => _uploadUniformsState(id, type, isGrouped);
}

class _uploadUniformsState extends State<uploadUniforms> {
  String id, type;
  bool isGrouped;
  _uploadUniformsState(this.id, this.type, this.isGrouped);
  ...
  var SchoolnamerController = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    if(type == "Exchange"){
      Heading = Text('Exchange Uniforms',
        style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,
          fontSize: 40,), textAlign: TextAlign.center,);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    FormBuilderTextField(
                      autovalidateMode:AutovalidateMode.disabled,
                      controller: SchoolnamerController,
                      name: 'schoolname',
                      decoration: InputDecoration(
                    ...
                    FormBuilderTextField(
                      ...
                      name: 'color',
                      decoration: InputDecoration(
                          labelText: 'Enter Color of uniform'
                      ),
                    ...
                    Container(
                      child: TextButton(onPressed: (){
                        ...
                        if(_formKey.currentState?.validate() == true) {
                          ...
                          print("Category:" + SchoolnamerController.toString());
                          UniformSizeController = _formKey.currentState?.fields["size"]?.value;
                          print("Category:" + UniformSizeController.toString());
                          ...
                          print("Type:" + reasonforexchangeController.toString());
                          print("Type:" + requiredamountorproductController.toString());


                          _insertProduct(type,context, id, productnameController.text, producrdescriptionController.text, _base64Image, productconditionController, SchoolnamerController.text, UniformSizeController.toString(), GenderController.toString(), ColorController.text, OtherdetailsController.text, reasonforexchangeController.text, exchangeSourceController.toString(), requiredamountorproductController.text, formattedDate.toString(), isGrouped, quantityofGroupedProductsController.text);
                          Navigator.push(
...
Future<void> _insertProduct(String _type,BuildContext context, String userid,String _productname,String _productDescription, String _image, double _condition, String _schoolName, String _size, String _gender, String _color, String _otherDetails, String _exchangereason, String _exchangesource, String _requiredamountorproduct, String _dateTime, bool _isGrouped, String _quantityofGroupedProducts) async {
  var _id = mongo.ObjectId();
  if(_type == "Donate"){
    final data = MongoDbProducts(id: _id, userid: userid, productcategory: "Uniforms", productype: _type, image: _image, productname: _productname, productdescription: _productDescription, productcondition: _condition, authorname: "", booksubject: "", noofpages: "", uniformSize: _size, schoolname: _schoolName, shoesSize: "", shoesstyle: "", bagtype: "", stationaryname: "", noofitemsstationary: "", grade: "", gender: _gender, color: _color, extrainformation: _otherDetails, exchangereason: "",exchangesource: "", requiredamountorproduct: "", dateTime: _dateTime, isgrouped: _isGrouped, quantityofGroupedProducts: _quantityofGroupedProducts, isaccapted: false, buyerid: "");
  ...
  if(_type == "Exchange"){
    print(_type);
    final data = MongoDbProducts(id: _id, userid: userid, productcategory: "Uniforms", productype: _type, image: _image, productname: _productname, productdescription: _productDescription, productcondition: _condition, authorname: "", booksubject: "", noofpages: "", uniformSize: _size, schoolname: _schoolName, shoesSize: "", shoesstyle: "", bagtype: "", stationaryname: "", noofitemsstationary: "", grade: "", gender: _gender, color: _color, extrainformation: "", exchangereason: _exchangereason,exchangesource: _exchangesource, requiredamountorproduct: _requiredamountorproduct, dateTime: _dateTime, isgrouped: _isGrouped, quantityofGroupedProducts: _quantityofGroupedProducts, isaccapted: false, buyerid: "");
    var result = await mongoDatabase.insert_product(data);
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Product Uploaded " )));
  }
}
