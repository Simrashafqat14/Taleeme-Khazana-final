...
class uploadBooks extends StatefulWidget {
  ...
  const uploadBooks({Key? key, required this.id  , required this.type, required this.isGrouped}) : super(key: key);

  @override
  State<uploadBooks> createState() => _uploadBooksState(id, type, isGrouped);
}

class _uploadBooksState extends State<uploadBooks> {
  String id, type;
  bool isGrouped;
  _uploadBooksState(this.id, this.type, this.isGrouped);
  ...
  var booktypeController = new TextEditingController();
  var BookSubjectController = new TextEditingController();
  var BookGradeController = new TextEditingController();
  var NoofPagesController = new TextEditingController();
        ...
        children: [
          ...
          FormBuilderDropdown(
            ...
            items: exchangeSourceOption.map((exchangeOptions) =>
                DropdownMenuItem(
                    value: exchangeOptions, child: Text('$exchangeOptions'))
            ).toList(),
          ),
          SizedBox(
            height: 30,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    //   name: 'booktype',
                    //   decoration: InputDecoration(
                    //       labelText: 'Enter Book Type(novel, school book etc)'
                    //   ),
                    //
                    //   validator: FormBuilderValidators.compose(
                    //       [FormBuilderValidators.required()]),
                    ...
                    FormBuilderTextField(
                      autovalidateMode: AutovalidateMode.disabled,
                      controller: BookGradeController,
                      name: 'bookgrade',
                      decoration: InputDecoration(
                          labelText: 'Enter Grade(If school book)'
                      ),
                    ...
                    FormBuilderTextField(
                      ...
                      name: 'noofpages',
                      decoration: InputDecoration(
                          labelText: 'Enter Total no of pages'
                      ),
                      ...
                      child: TextButton(onPressed: () {
                       ...
                       // print(image);
                        if (_formKey.currentState?.validate() == true) {
                          ...
                          print("Description:" +
                              producrdescriptionController.toString());
                          //productimageController = _formKey.currentState!.fields["image"]!?.value.toString();
                          //image != null ? Image.file(image!);
                          //print("Image:" + image.toString());
                          productconditionController =
                              _formKey.currentState?.fields["Condition"]?.value;
                          print("Condition:" +
                              productconditionController.toString());
                          print("Category:" + bookauthorController.toString());
                          print("Type:" + booktypeController.toString());
                          print("Type:" + BookSubjectController.toString());
                          print("Type:" + BookGradeController.toString());
                          print("Type:" + NoofPagesController.toString());
                          ...
                          _insertProduct(
                            type,
                              ...
                              producrdescriptionController.text,
                              _base64Image,
                              productconditionController,
                              bookauthorController.text,
                              BookSubjectController.text,
                              BookGradeController.text,
                              NoofPagesController.text,
                              OtherdetailsController.text,
                              reasonforexchangeController.text, exchangeSourceController.toString()
                              , requiredamountorproductController.text, formattedDate.toString(), isGrouped,quantityofGroupedProductsController.text);
                          Navigator.push(
...
// var NoofPagesController = new TextEditingController();
// var OtherdetailsController = new TextEditingController();
// var usageDurationController = new TextEditingController();

Future<void> _insertProduct(String _type,BuildContext context, String userid,String _productname,String _productDescription, String _image, double _condition, String _bookAuthor, String _bookSubject, String _bookGrade, String _noOfPages, String _otherDetails, String _exchangereason, String _exchangesource, String _requiredamountorproduct, String _dateTime, bool _isGrouped , String _quantityofGroupedProducts ) async {
  ...
  if(_type == "Donate") {
    final data = MongoDbProducts(id: _id,
        ...
        dateTime: _dateTime,
        isgrouped: _isGrouped, quantityofGroupedProducts: _quantityofGroupedProducts, isaccapted: false, buyerid: "");
