...
class categoryPage extends StatefulWidget {
  ...
  const categoryPage({Key? key, required this.id,required this.type}) : super(key: key);
  @override
  State<categoryPage> createState() => _categoryPageState(id,type);
}
class _categoryPageState extends State<categoryPage> {
  String id,type;
  _categoryPageState(this.id,this.type);
  List<String> images = [
                              ...
                              onPressed: () {
                                if (category[index] == "Books") {
                                  ...
                                  Navigator.push(
                                      context, MaterialPageRoute(
                                      builder: (BuildContext context) {
                                        return productsCategoryPage(id: id,
                                          category: category[index],
                                          type: type,);
                                      }));
                                }
