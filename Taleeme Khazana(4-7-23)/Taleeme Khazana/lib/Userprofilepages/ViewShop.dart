...
class ViewPurchaseShop extends StatefulWidget {
  final String id, userid;
  final MongoDbModel userdata;
  const ViewPurchaseShop({Key? key,required this.id, required this.userdata, required this.userid}) : super(key: key);

  @override
  State<ViewPurchaseShop> createState() => _ViewPurchaseShopState(id, userdata, userid);
}

class _ViewPurchaseShopState extends State<ViewPurchaseShop> {

  String id, userid;
  MongoDbModel userdata;
  _ViewPurchaseShopState(this.id, this.userdata, this.userid);
                                  ...
                                  Navigator.push(context,
                                      MaterialPageRoute(
                                          builder: (BuildContext context) {
                                            return ViewProfile(id: data.userid, userid: userid,);
                                          },
                                  ...
                                  child: SafeArea(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          FutureBuilder(
                                            future: mongoDatabase.getpurchaseProductbyuserandonsale(data.userid, false),
                                  ...
                                  child: SafeArea(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          FutureBuilder(
                                            future: mongoDatabase.getpurchaseProductbyuserandonsale(data.userid, true),
                                            builder: (context, AsyncSnapshot snapshot) {
                                              if (snapshot.connectionState ==
                                                  ConnectionState.waiting) {
                                                return Center(child:
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (BuildContext context) {
                  return PurchaseProductPage(id: userid, category: data.productcategory,);
